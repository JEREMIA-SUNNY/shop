          ...
          <div key={id}>
            <div className="h-[70vh] w-full relative flex justify-center items-center">
              <Image
                ...
                alt=""
              />
              <div className="absolute inset-0 bg-white opacity-50  text-black border w-[730px] rounded-r-full"></div>
              <div className="absolute inset-0 bg-white text-black border w-[700px] rounded-r-full">
                <div className="flex justify-center mt-4"> <img src="/icons/shop.gif" className="w-[100px] h-[100px]" alt="" /></div>
