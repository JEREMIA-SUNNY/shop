        ...
        <div className="container mx-auto lg:gap-16  flex px-5 py-14 md:items-start items-center md:flex-row flex-col ">
          <div className="lg:flex-grow md:w-1/2  flex  flex-col  text-left  md:mb-0  ">
            ...
            <p className="mb-8 leading-relaxed">
              ...
              dolor sit amet consectetur adipisicing elit. Harum est perferendis
              repudiandae modi, maiores doloremque rem neque dolorem excepturi
              officiis tenetur aliquid iusto dolorum. Architecto, odio! Autem
